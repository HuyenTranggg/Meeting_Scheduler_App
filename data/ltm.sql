...
(203, '15:00:00', '16:30:00', '2026-01-15', 'personal', 'busy', 110),
(204, '08:30:00', '10:00:00', '2026-01-16', 'group', 'free', 111),
(205, '10:30:00', '12:00:00', '2026-01-16', 'personal', 'busy', 111),
...
(209, '11:00:00', '12:30:00', '2026-01-17', 'group', 'busy', 112),
...
(213, '10:00:00', '11:30:00', '2026-01-18', 'personal', 'busy', 113),
...
(217, '10:30:00', '12:00:00', '2026-01-20', 'group', 'busy', 114),
...
(222, '14:00:00', '15:30:00', '2025-01-21', 'both', 'busy', 110),
...
(300, 203, 'completed', 'personal', 'Cuộc họp đã hoàn thành tốt. Sinh viên đã trình bày đề tài về Machine Learning và nhận được nhiều đóng góp hữu ích từ giáo viên.'),
(301, 205, 'completed', 'personal', 'Thảo luận về đồ án tốt nghiệp. Sinh viên cần hoàn thiện phần thiết kế database và cải thiện giao diện người dùng.'),
(302, 209, 'completed', 'group', 'Họp nhóm dự án Web Development. Các thành viên đã phân công công việc rõ ràng cho sprint tiếp theo.'),
(303, 213, 'completed', 'personal', 'Tư vấn về hướng nghiên cứu cho luận văn thạc sĩ. Đề xuất sinh viên tập trung vào Deep Learning cho xử lý ảnh y khoa.'),
(304, 217, 'completed', 'group', 'Review tiến độ dự án Mobile App. Team đang đúng kế hoạch, cần tăng cường testing trong tuần tới.'),
(305, 222, 'completed', 'group', 'Hướng dẫn sinh viên về cách viết báo cáo khoa học. Đã cung cấp template và các tài liệu tham khảo cần thiết.'),
(306, 226, 'completed', 'personal', 'Thảo luận về đề tài nghiên cứu AI trong giáo dục. Sinh viên có ý tưởng tốt nhưng cần cụ thể hóa phương pháp nghiên cứu.'),
(307, 201, 'confirmed', 'group', NULL),
(308, 204, 'confirmed', 'group', NULL),
(309, 206, 'pending', 'personal', NULL),
(310, 207, 'pending', 'group', NULL),
(311, 208, 'pending', 'personal', NULL),
(312, 210, 'confirmed', 'personal', NULL),
(313, 211, 'pending', 'personal', NULL),
(314, 212, 'confirmed', 'group', NULL),
(315, 214, 'pending', 'group', NULL),
(316, 215, 'pending', 'group', NULL),
(317, 216, 'confirmed', 'personal', NULL),
(318, 218, 'pending', 'personal', NULL),
(319, 219, 'pending', 'personal', NULL),
(320, 220, 'confirmed', 'group', NULL),
(321, 221, 'pending', 'personal', NULL),
(322, 223, 'pending', 'group', NULL),
(323, 224, 'confirmed', 'personal', NULL),
(324, 225, 'pending', 'group', NULL),
(325, 227, 'pending', 'personal', NULL);
